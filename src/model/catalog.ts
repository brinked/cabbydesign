...
export const FINISHES: FinishOption[] = [
  ...
  { id: 'sb-mocha', name: 'Mocha Woodgrain', woodgrain: true, texUpright: true, texPbr: true, tex: 'starboard/mocha.jpg', body: '#513e37', panel: '#513e37', inner: '#42322d', counter: '#e3e0da' },
  { id: 'sb-nutmeg', name: 'Nutmeg Woodgrain', woodgrain: true, texUpright: true, texPbr: true, tex: 'starboard/nutmeg.jpg', body: '#827a70', panel: '#827a70', inner: '#6a645b', counter: '#e3e0da' },
  ...
  { id: 'sb-charcoal', name: 'Charcoal Woodgrain', woodgrain: true, texUpright: true, texPbr: true, tex: 'starboard/charcoal.jpg', body: '#3d4144', panel: '#3d4144', inner: '#323537', counter: '#e3e0da' },
  { id: 'sb-slate', name: 'Slate Woodgrain', woodgrain: true, texUpright: true, texPbr: true, tex: 'starboard/slate.jpg', body: '#6f6c67', panel: '#6f6c67', inner: '#5b5854', counter: '#e3e0da' },
...
const BASE_CATALOG: CatalogItem[] = [
  ...
  { id: 'out-kamado', name: 'Kamado Cabinet', category: 'outdoor', front: 'kamado', lane: 'floor', w: 36, d: 30, h: 20, minW: 30, maxW: 42, stepW: 2, counter: true, topGearH: 40, formula: BOX, applianceCat: 'kamado', note: 'Pedestal cabinet — the kamado sits on its counter, so a 20" box puts the cooking surface at working height.' },
  { id: 'out-kamado-builtin', name: 'Built-In Kamado Cabinet', category: 'outdoor', front: 'kamadoinsert', lane: 'floor', w: 36, d: 30, h: BASE_H, minW: 30, maxW: 42, stepW: 2, counter: true, topGearH: 20, formula: BOX, applianceCat: 'kamado', note: 'Open 12" top compartment the kamado drops into. The counter runs across with a cut-out over the opening.' },
...
export const CATALOG: CatalogItem[] = [
  ...
  ...BASE_CATALOG.filter(
    ...
    (c) => c.lane === 'floor' && (c.category === 'base' || c.category === 'outdoor') && !c.hideFromAdd && !c.barHeight && !c.line && !c.fixed && !c.hidden && BAR_FRONTS.has(c.front),
  ).map(barVariant),
];
